...
public class AulaVirtualEstudianteInterceptor extends CampusBaseInterceptor {
	...
	protected String intercepcion(ActionInvocation inv, Usuario user)
		...
		log.warn("intercepcion(): " + getInvocationAction(inv) + " - Usuario no es Estudiante: "+user);
