...
public class PDFReport {
	...
	public static Document getNewDocumentPDF() throws Exception{
		...
		doc.addKeywords("Tecsup Virtual, alumno, reporte, auditoria, nota");
	...
	public static void dibujarReportePDF(AulaVirtual aula, ReporteDetalle reporte,Document doc) throws Exception{
		if(aula != null && reporte != null && doc != null){
			...
			cell = new  PdfPCell(subTable.getDefaultCell());
			cell.setPhrase(new Phrase("Tecsup Virtual", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
			subTable.addCell(cell);
			...
			cell = new  PdfPCell(subTable.getDefaultCell());
			cell.setPhrase(new Phrase("www.tecsup.edu.pe", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
			cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			subTable.addCell(cell);
			...
			cell = new  PdfPCell(subTable.getDefaultCell());
			cell.setPhrase(new Phrase("soporte@tecsup.edu.pe", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
			cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			subTable.addCell(cell);
