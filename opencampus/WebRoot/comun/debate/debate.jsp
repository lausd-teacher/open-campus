							...
							<tr>
								<td height="15" align="right">
									...
									<c:if test="${!esInvitado || esAdmin}">
										<tr>
											<td align="right">
												<a href="#"> <input type="button" value="Nuevo Debate" class="form_button" onClick="nuevoPadre()" id="btnNvoTma">
												</a>
											</td>
										</tr>
									</c:if>
										<tr>
											<td align="left">
												<div id="nuevoTema" style="display: none">
													...
													<form method="post"
														action="<%=request.getContextPath()%>/aulavirtual/debate/Crear.action" onSubmit="return validaTema();">
								...
								<table width="100%" border="0" cellpadding="4" cellspacing="0"
									...
									<tbody>
										<caption class="fon_cab tit_cab">
												Debate: <c:out value="${UNIDAD_NOMBRE_TEMP}"></c:out>
										</caption>
										...
										<c:forEach items="${debates}" var="dialogo" varStatus="status">
...
onclick="window.document.location =xGetContextPath() +'/aulavirtual/debate/CargarSala.action?idDebate=<c:out value="${dialogo.idDebate}"></c:out>';"												
												>
													<c:choose>
...
onclick="window.document.location =xGetContextPath() +'/aulavirtual/debate/CargarSala.action?idDebate=<c:out value="${dialogo.idDebate}"></c:out>';"													
												...
												<c:if test="${esAdmin}">
													...
													href="<%=request.getContextPath() %>/aulavirtual/debate/Eliminar.action?idDebate=<c:out value="${dialogo.idDebate}"></c:out>" >
