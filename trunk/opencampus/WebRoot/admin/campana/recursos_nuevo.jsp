...
<div id="pop_up">
  ...
  <c:out value="${mensaje_texto}"></c:out><c:out value="${param.mensaje_texto}"></c:out>
    <form name="form1" onSubmit="return enviarPublicacion('titulo','doc','2')" action="<%=contexto%>/admin/ficha/PublicarLectura.action" enctype="multipart/form-data" method="post" >
...
<input type="hidden" name="busquedaPeriodo" value="<c:out value="${param.busquedaPeriodo}"></c:out>">
        ...
        <tr align="left">
          <td colspan="2" align="center"><input name="Submit2222" type="submit" class="form_button" value="<s:text name="aula.alumno.lecturas.boton.enviar"/>" /></td>
        </tr>
      </table>
    </form>
  </div>  
