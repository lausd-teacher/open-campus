				...
				<form method="post" id="tecsupVirtual">
					...
					class="tablaFicha">
						...
						<tr>
							...
							<td>
								<input type="button" value="Generar" class="form_button" onclick="if(validarAuditoria())searchAuditoria('<%=(usuario.getRolPredeterminado()==Constante.ROL_CAMPUS_JEFE_DEPARTAMENTO)?request.getContextPath()+"/reporte/AuditoriaDepartamento.action":request.getContextPath()+"/reporte/AuditoriaTecsupVirtual.action"%>')"/>
							</td>
						</tr>
					</table>
				</form>
