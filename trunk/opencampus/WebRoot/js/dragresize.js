...
function DragResize(myName, config)
{
 var props = {
  ...
  isResizable: false,              // Indica si las ventanas seran redimensionables
  handles: ['tl', 'tm', 'tr',
...
DragResize.prototype.select = function(newElement) { with (this)
{
 ...
 if (newElement && (newElement != element) && enabled)
 {
  ...
  if (this.isResizable) this.resizeHandleSet(element, true);
...
DragResize.prototype.deselect = function(delHandles) { with (this)
{
 ...
 if (delHandles)
 {
  ...
  if (this.isResizable) this.resizeHandleSet(element, false);
  element = null;
 }
...
DragResize.prototype.mouseMove = function(e) { with (this)
{
 ...
 var isResize = false;
 if (this.isResizable && this.resizeHandleDrag(diffX, diffY))
 {
  isResize = true;
 }
 else
