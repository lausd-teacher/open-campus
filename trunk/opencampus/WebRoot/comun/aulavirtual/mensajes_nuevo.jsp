...
<div id="pop_up">
  ...
  <div id="pop_cuerpo" style="width: 500px;">
    <form id="form1" name="form1" method="post"  onSubmit="return enviarPublicacion('titulo','mensaje','1')" action="<%=request.getContextPath()%>/aulavirtual/PublicarMensaje.action">
          ...
          <td colspan="2"><table width="100%">
            <tr>
              <td width="50%" align="right">
                <input name="Submit2" type="button" class="form_button" value="<s:text name="aula.alumno.pop_up.avisos.boton.regresar"/>" onClick="document.location.href='Mensajes.action'"/>              </td>
              <td width="50%" align="left">
                <input type="submit" class="form_button" value="<s:text name="aula.alumno.pop_up.avisos.boton.guardar"/>"></td>
            </tr>
          </table></td>
        </tr>
      </table>
