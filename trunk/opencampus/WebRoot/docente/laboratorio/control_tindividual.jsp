...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="<c:out value='${contextPath}'/>/docente/laboratorio/control_tindividual.js"></script>
...
<div id="pop_up" style="width: 520px;">
			...
			<table width="500" align="center" style="table-layout: fixed;" cellpadding="3" border="0" cellspacing="0" bgcolor="#FFFFFF" class="bor_tabla">
				...
				<tr id="dTR_3" style="display: none;">
					...
					<td align="right" style="padding-right: 10px"> 
						<input type="button" class="form_button" value="Modificar laboratorio"
	  ...
	  <div id="form_TGrupal" style="display: <c:out value='${display}' />">
		...
		method="post" 
		action="<c:out value='${contextPath}'/>/aulavirtual/laboratorio/PublicarTrabajoX.action" enctype="multipart/form-data">
			<table width="500" align="center" style="table-layout: fixed;" cellpadding="3" border="0" cellspacing="0" bgcolor="#FFFFFF" class="bor_tabla">
...
<%--						<iframe src="<c:out value='${contextPath}'/>/aulavirtual/laboratorio/CargarForm.action" id="uploadForm" frameborder="0" marginwidth="0" width="360" marginheight="0" height="25" scrolling='no'></iframe>--%>
					...
					<td width="120" style="padding-right: 10px">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<small> (<fmt:formatNumber value="${ti.interaccion.archivoTamanio/1024}" maxFractionDigits="2"/> KB)</small>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<c:out value='${contextPath}'/>/aulavirtual/laboratorio/EliminarTrabajo.action?filename=<c:out value='${ti.interaccion.archivoNombre}'/>"
...
<%--						<input type="hidden" id=form_tamArchivo value="" name="aTamanio">--%>
				...
				<tr>
					...
					<td align="right" colspan="2" style="padding-right: 10px">
						...
						<c:choose>
	  						<c:when test="${ti.fechaActivacion == null}">
								<input type="submit" id="form_button" class="form_button" value="Publicar Laboratorio"/>
							</c:when>
							<c:otherwise>
	      ...
	      >
	          ...
	          <td align="center">
	          	<c:if test='${matricula.estado != estadoIniEst}'>
	          		<a href="<c:out value='${contextPath}' />/aulavirtual/laboratorio/VerMensajesDeDocente.action?idMatricula=<c:out value='${matricula.usuarioReceptor.idMatricula}'/>">
