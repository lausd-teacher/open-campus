...
public class SendMail {
	...
	private static final String TITULOBUZON = "Mensaje del Campus Virtual de opencampus";
	...
	private String correoReenvio(String usuario, String asunto, String fecha,
		...
		return "El Señor(ita) "
				...
				+ " opencampus.</p></td></tr><tr><td colspan=\"3\"/></tr><tr>"
	...
	private void redireccionCorreoCopia(String to, String subject,
		...
		//mensaje.setRecipients(Message.RecipientType.BCC, InternetAddress.parse("drodriguez@opencampus.edu.pe"));
		
//		mensaje.setFrom(new InternetAddress("ebenites@opencampus.edu.pe"/*Constante.DIRECCION_CORREO_SALIENTE*/));
...
//		mensaje.setRecipients(Message.RecipientType.BCC, InternetAddress.parse("arsjajrajezkrzk@opencampus.edu.pe"/*"drodriguez@opencampus.edu.pe"*/));
