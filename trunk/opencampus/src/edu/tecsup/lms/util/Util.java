...
import edu.tecsup.lms.modelo.Departamento;
...
*/
	...
	*/
	...
	public static Map<String, String> obtenerUsuariosRedireccionCorreo() {
		...
		usuarios.put("abejarano", "abejarano@tecsup.edu.pe");
		usuarios.put("drodriguez", "drodriguez@tecsup.edu.pe");
		usuarios.put("jbastante", "jbastante@tecsup.edu.pe");
		usuarios.put("lmaza", "lmaza@tecsup.edu.pe");
		usuarios.put("mchuquiruna", "mchuquiruna@tecsup.edu.pe");
		usuarios.put("amarchese", "amarchese@tecsup.edu.pe");
		usuarios.put("amorales", "amorales@tecsup.edu.pe");
		usuarios.put("jmusayon", "jmusayon@tecsup.edu.pe");
		usuarios.put("eramirez", "eramirez@tecsup.edu.pe");
		usuarios.put("mrivera", "mrivera@tecsup.edu.pe");		
		usuarios.put("ofrech", " ofrech@tecsup.edu.pe");
		usuarios.put("dmunoz", " dmunoz@tecsup.edu.pe");
		usuarios.put("mvicente", "mvicente@tecsup.edu.pe");
		usuarios.put("ebenites", "ebenites@tecsup.edu.pe");
		return usuarios;
	}
/*
