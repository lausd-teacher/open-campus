...
import edu.tecsup.lms.modelo.aulavirtual.reporte.MatriculaIngreso;
import edu.tecsup.lms.modelo.aulavirtual.reporte.ReporteDetalle;
import edu.tecsup.lms.modelo.reporte.FichaReporte;
...
import edu.tecsup.lms.modelo.reporte.UsuarioReporte;
import edu.tecsup.lms.modelo.reportesecdoc.FichaReporteSecDoc;
...
public class ReporteDAO extends BaseDAO {
	...
	public Collection<UsuarioReporteSecDoc> busquedaSecDoc(
		...
		Connection cons = null;
		try {
			String query = "SELECT DISTINCT segu.usuario,pere.codtecsup,genpe.apepaterno,"
			...
			while (result.next()) {
				...
				usuario.setCodTecsup(result.getString("codtecsup"));
	...
	public Collection<UsuarioReporteSecDoc> busquedaSecDoc(String[] idMatricula)
		...
		try {
			...
			query = "SELECT DISTINCT segu.usuario,pere.codtecsup,genpe.apepaterno,"
					+ "genpe.apematerno,genpe.nomuno,genpe.nomdos FROM cv_matricula cvma,"
					+ "cv_ficha cvfi,seguridad.seg_usuario segu,general.gen_persona genpe,"
	...
	public void busquedaSecDocExcel(String[] idMatricula, Usuario usuario,
		...
		try {
			...
			query = "SELECT pere.codtecsup,pkg_cv_util.fx_cv_formato_nombre(cvma.usuario) "
	...
	public Collection<TecsupVirtualReporte> obtenerAuditoriaTecsupVirtual(ReporteFiltro filtro) throws DAOException {
		log.info("obtenerAuditoriaTecsupVirtual(ReporteFiltro filtro)");
		PreparedStatement stmt = null;
		ResultSet result = null;
		ResultSet subResult = null;
		Connection cons = null;
		Collection<TecsupVirtualReporte> auditoria = new ArrayList<TecsupVirtualReporte>();
		Collection<GregorianCalendar> ingresos = null;
		TecsupVirtualReporte registro = null;
		...
		try {
			...
			while (result.next()) {
				registro = new TecsupVirtualReporte();
	...
	public Collection<TecsupVirtualReporte> obtenerReporteTecsupVirtual(ReporteFiltro filtro) throws DAOException {
		log.info("obtenerReporteTecsupVirtual(ReporteFiltro filtro)");
		PreparedStatement stmt = null;
		ResultSet result = null;
		Connection cons = null;
		Collection<TecsupVirtualReporte> auditoria = new ArrayList<TecsupVirtualReporte>();
